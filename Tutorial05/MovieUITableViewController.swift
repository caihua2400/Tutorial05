...
class MovieUITableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        database.insert(movie:Movie(ID: 0, name:"Lord of the Rings", year:2003,
                                    director:"Peter Jackson"))
        database.insert(movie:Movie(ID: 1, name:"The Matrix", year:1999, director:"Lana Wachowski, Lilly Wachowski"))
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let movieCell = cell as? MovieUITableViewCell
        {
            ...
            movieCell.subTileLabel.text = String(movie.year)
        }
        return cell
    }
